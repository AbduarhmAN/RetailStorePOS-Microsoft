...
namespace RetailStorePOS.UI.Tax.Views;
...
public sealed partial class TaxConfigurationPage : Page
{
    ...
    private async Task<TaxRule?> ShowTaxRuleEditorDialog(TaxRule? existing)
    {
        ...
        foreach (var item in System.Linq.Enumerable.ToList(calcTypes))
        {
        ...
        foreach (var item in System.Linq.Enumerable.ToList(scopes))
        {

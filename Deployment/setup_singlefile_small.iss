; Size-optimized Inno Setup script for the single-file standalone EXE lane.

#ifndef MyAppName
  #error MyAppName is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyAppVersion
  #error MyAppVersion is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyAppBinaryVersion
  #error MyAppBinaryVersion is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyAppPublisher
  #error MyAppPublisher is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyAppExeName
  #error MyAppExeName is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyAppExeSourcePath
  #error MyAppExeSourcePath is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyOutputBaseFilename
  #error MyOutputBaseFilename is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MySetupIconFile
  #error MySetupIconFile is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyLicenseFile
  #error MyLicenseFile is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyWizardImageFile
  #error MyWizardImageFile is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif

#ifndef MyWizardSmallImageFile
  #error MyWizardSmallImageFile is required. Run build-singlefile-installer-small.ps1 so metadata is injected automatically.
#endif
...
OutputDir=artifacts\installer-singlefile-small

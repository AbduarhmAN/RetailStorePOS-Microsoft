; Script generated for Inno Setup script files.
  ...
  #error MyAppBinaryVersion is required. Run build-uptodown-installer.ps1 so metadata is injected automatically.
#endif
...
begin
  ...
  // Write initial preferences as soon as the user continues past the license page.
  // The app resolves the stable install identifier on first launch from device signals.

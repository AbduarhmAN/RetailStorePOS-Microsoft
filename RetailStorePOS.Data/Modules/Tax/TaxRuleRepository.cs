...
VALUES (@id, @old, @new, @now, @uid);";
    ...
    private static TaxRule MapTaxRule(SqliteDataReader reader)
    {
        return new TaxRule
        {
            ...
            TaxAuthorityId = reader.IsDBNull(2) ? null : Convert.ToInt64(reader.GetValue(2)),
            CalcType = reader.GetString(3),
            Scope = reader.GetString(4),
            RateValue = (decimal)Convert.ToDouble(reader.GetValue(5)),
            IsInclusive = Convert.ToInt32(reader.GetValue(6)) == 1,
            AppliesAfterDiscount = Convert.ToInt32(reader.GetValue(7)) == 1,
            SequenceOrder = Convert.ToInt32(reader.GetValue(8)),
            MinTaxAmountCents = reader.IsDBNull(9) ? null : Convert.ToInt64(reader.GetValue(9)),
            MaxTaxAmountCents = reader.IsDBNull(10) ? null : Convert.ToInt64(reader.GetValue(10)),
            ThresholdMinCents = reader.IsDBNull(11) ? null : Convert.ToInt64(reader.GetValue(11)),
            ThresholdMaxCents = reader.IsDBNull(12) ? null : Convert.ToInt64(reader.GetValue(12)),
            ...
            IsActive = Convert.ToInt32(reader.GetValue(16)) == 1,
            IsDefault = Convert.ToInt32(reader.GetValue(17)) == 1,

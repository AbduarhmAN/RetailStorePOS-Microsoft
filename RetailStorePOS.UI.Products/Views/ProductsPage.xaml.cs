...
using RetailStorePOS.UI.Products.Models;
using Windows.Storage.Pickers;
using WinRT.Interop;
using System.Threading;
using System.Threading.Tasks;

namespace RetailStorePOS.UI.Products.Views;
...
public sealed partial class ProductsPage : Page, INotifyPropertyChanged
{
    ...
    private bool _refreshOnNextLoad;
    private bool _subscriptionsAttached;
    private int _taxCategoriesLoadVersion;
    private int _taxPickerLoadVersion;
    private int _productReloadVersion;
    private IReadOnlyDictionary<long, TaxGroup> _taxGroupsById = new Dictionary<long, TaxGroup>();
    private static readonly bool EnableVerboseHotPathTrace = false;

    public ProductsPage()
    {
        NavigationCacheMode = Microsoft.UI.Xaml.Navigation.NavigationCacheMode.Required;
        InitializeComponent();
        _uiDispatcher = DispatcherQueue.GetForCurrentThread() ?? DispatcherQueue;
        _localizationChangedHandler = (_, _) => RefreshLocalizedProperties();
    ...
    {
        OnPropertyChanged(nameof(Products_Button_Add));
        OnPropertyChanged(nameof(Products_Button_Clear));
        OnPropertyChanged(nameof(Products_Button_Export));
        OnPropertyChanged(nameof(Products_Button_Import));
        OnPropertyChanged(nameof(Products_Button_Refresh));
        OnPropertyChanged(nameof(Products_Button_RemovePicture));
        OnPropertyChanged(nameof(Products_Count_None));
        OnPropertyChanged(nameof(Products_Count_Subtitle));
        OnPropertyChanged(nameof(Products_Details_Cancel));
        OnPropertyChanged(nameof(Products_Details_Delete));
        OnPropertyChanged(nameof(Products_Details_EditSubtitle));
        OnPropertyChanged(nameof(Products_Details_EditTitle));
        OnPropertyChanged(nameof(Products_Details_NewSubtitle));
        OnPropertyChanged(nameof(Products_Details_NewTitle));
        OnPropertyChanged(nameof(Products_Details_SelectProduct));
        OnPropertyChanged(nameof(Products_Details_SelectSubtitle));
        OnPropertyChanged(nameof(Products_Details_Transfer));
        OnPropertyChanged(nameof(Products_Dialog_Transfer_Title));
        OnPropertyChanged(nameof(Products_Dialog_Transfer_PrimaryButtonText));
        OnPropertyChanged(nameof(Products_Dialog_Transfer_CloseButtonText));
        OnPropertyChanged(nameof(Products_Dialog_Transfer_QtyToMove));
        OnPropertyChanged(nameof(Products_Dialog_Transfer_StoreQty));
        OnPropertyChanged(nameof(Products_Dialog_Transfer_Text));
        OnPropertyChanged(nameof(Products_Dialog_Transfer_WarehouseQty));
        OnPropertyChanged(nameof(Products_Header_Title));
        OnPropertyChanged(nameof(Products_Label_Barcode));
        OnPropertyChanged(nameof(Products_Label_CostPrice));
        OnPropertyChanged(nameof(Products_Label_LastSaleAt));
        OnPropertyChanged(nameof(Products_Label_Name));
        OnPropertyChanged(nameof(Products_Label_Name_Required));
        OnPropertyChanged(nameof(Products_Label_PurchasedAt));
        OnPropertyChanged(nameof(Products_Label_SellPrice));
        OnPropertyChanged(nameof(Products_Label_SellPrice_Required));
        OnPropertyChanged(nameof(Products_Label_SKU));
        OnPropertyChanged(nameof(Products_Label_StoreQty));
        OnPropertyChanged(nameof(Products_Label_StoreThreshold));
        OnPropertyChanged(nameof(Products_Label_Tax));
        OnPropertyChanged(nameof(Products_Label_Unit));
        OnPropertyChanged(nameof(Products_Label_WarehouseQty));
        OnPropertyChanged(nameof(Products_Label_WarehouseThreshold));
        OnPropertyChanged(nameof(Products_Search_Placeholder));
        
        // Also refresh existing ones
        ...
        OnPropertyChanged(nameof(ImportFailureTipSkipText));
        ...
        // Reload lists that contain localized headers or item names
        LoadTaxPickerItems();
    }
    ...
    public DataTemplate ProductItemTemplate =>
        (DataTemplate)Resources[CanOverridePrice ? "PP_ProductItemWithPriceTemplate" : "PP_ProductItemWithoutPriceTemplate"];
    ...
    public string SelectedProductTaxText
    {
        get
        {
            ...
            var groupId = SelectedProduct.Product.TaxGroupId ?? 1L;
            ...
            if (_taxGroupsById.TryGetValue(groupId, out var group))
            {
    ...
    public string Products_Button_Add => Loc["Products_Button_Add.Label"];
    public string Products_Button_Clear => Loc["Products_Button_Clear.Label"];
    public string Products_Button_Export => Loc["Products_Button_Export.Label"];
    public string Products_Button_Import => Loc["Products_Button_Import.Label"];
    public string Products_Button_Refresh => Loc["Products_Button_Refresh.Label"];
    public string Products_Button_RemovePicture => Loc["Products_Button_RemovePicture.Content"];
    public string Products_Count_None => Loc["Products_Count_None.Text"];
    public string Products_Count_Subtitle => Loc["Products_Count_Subtitle.Text"];
    public string Products_Details_Cancel => Loc["Products_Details_Cancel.Label"];
    public string Products_Details_Delete => Loc["Products_Details_Delete.Label"];
    public string Products_Details_EditSubtitle => Loc["Products_Details_EditSubtitle.Text"];
    public string Products_Details_EditTitle => Loc["Products_Details_EditTitle.Text"];
    public string Products_Details_NewSubtitle => Loc["Products_Details_NewSubtitle.Text"];
    public string Products_Details_NewTitle => Loc["Products_Details_NewTitle.Text"];
    public string Products_Details_SelectProduct => Loc["Products_Details_SelectProduct.Text"];
    public string Products_Details_SelectSubtitle => Loc["Products_Details_SelectSubtitle.Text"];
    public string Products_Details_Transfer => Loc["Products_Details_Transfer.Label"];
    public string Products_Dialog_Transfer_Title => Loc["Products_Dialog_Transfer.Title"];
    public string Products_Dialog_Transfer_PrimaryButtonText => Loc["Products_Dialog_Transfer.PrimaryButtonText"];
    public string Products_Dialog_Transfer_CloseButtonText => Loc["Products_Dialog_Transfer.CloseButtonText"];
    public string Products_Dialog_Transfer_QtyToMove => Loc["Products_Dialog_Transfer_QtyToMove.Header"];
    public string Products_Dialog_Transfer_StoreQty => Loc["Products_Dialog_Transfer_StoreQty.Text"];
    public string Products_Dialog_Transfer_Text => Loc["Products_Dialog_Transfer_Text.Text"];
    public string Products_Dialog_Transfer_WarehouseQty => Loc["Products_Dialog_Transfer_WarehouseQty.Text"];
    public string Products_Header_Title => Loc["Products_Header_Title.Text"];
    public string Products_Label_Barcode => Loc["Products_Label_Barcode.Text"];
    public string Products_Label_CostPrice => Loc["Products_Label_CostPrice.Text"];
    public string Products_Label_LastSaleAt => Loc["Products_Label_LastSaleAt.Text"];
    public string Products_Label_Name => Loc["Products_Label_Name.Text"];
    public string Products_Label_Name_Required => Loc["Products_Label_Name_Required.Text"];
    public string Products_Label_PurchasedAt => Loc["Products_Label_PurchasedAt.Text"];
    public string Products_Label_SellPrice => Loc["Products_Label_SellPrice.Text"];
    public string Products_Label_SellPrice_Required => Loc["Products_Label_SellPrice_Required.Text"];
    public string Products_Label_SKU => Loc["Products_Label_SKU.Text"];
    public string Products_Label_StoreQty => Loc["Products_Label_StoreQty.Text"];
    public string Products_Label_StoreThreshold => Loc["Products_Label_StoreThreshold.Text"];
    public string Products_Label_Tax => Loc["Products_Label_Tax.Text"];
    public string Products_Label_Unit => Loc["Products_Label_Unit.Text"];
    public string Products_Label_WarehouseQty => Loc["Products_Label_WarehouseQty.Text"];
    public string Products_Label_WarehouseThreshold => Loc["Products_Label_WarehouseThreshold.Text"];
    public string Products_Search_Placeholder => Loc["Products_Search_Placeholder.PlaceholderText"];
    ...
    private void ProductsPage_Loaded(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            if (!_hasLoadedInitialData)
            {
                ...
                QueueActivationRefresh(focusSearch: true);
                return;
            }

            if (_refreshOnNextLoad)
            {
                _refreshOnNextLoad = false;
                QueueActivationRefresh(focusSearch: false);
            }
        }
        catch (Exception ex)
        {
    ...
    private void ProductsPage_Unloaded(object sender, RoutedEventArgs e)
    {
        ...
        _refreshOnNextLoad = true;
        Interlocked.Increment(ref _taxCategoriesLoadVersion);
        Interlocked.Increment(ref _taxPickerLoadVersion);
        Interlocked.Increment(ref _productReloadVersion);
        _isReloading = false;
    ...
    private void ReloadProducts(long? preferredProductId = null, bool focusSearch = false)
        => _ = ReloadProductsAsync(preferredProductId, focusSearch);

    private async Task ReloadProductsAsync(long? preferredProductId = null, bool focusSearch = false)
    {
        var operationVersion = Interlocked.Increment(ref _productReloadVersion);
        _isReloading = true;
        try
        {
            TracePageState("ReloadProducts:start");
            var previousId = preferredProductId ?? SelectedProduct?.Id;
            var searchTerm = SearchTerm;
            var products = await Task.Run(() => ProductSearchModule.Search(searchTerm, 500).ToList());

            if (IsProductReloadStale(operationVersion))
            {
                return;
            }
            ...
            await RunOnUiThreadAsync(() =>
            {
                ...
                if (focusSearch)
                {
                    ...
                    TracePageState("ReloadProducts:after SearchTextBox.Focus");
                }
        ...
        finally
        {
            if (!IsProductReloadStale(operationVersion))
            {
                await RunOnUiThreadAsync(() => _isReloading = false);
            }
        }
    }

    private void LoadTaxCategories()
        => _ = LoadTaxCategoriesAsync();

    private async Task LoadTaxCategoriesAsync()
    {
        var operationVersion = Interlocked.Increment(ref _taxCategoriesLoadVersion);
        try
        {
            var categories = await Task.Run(() => TaxCategoriesModule.GetAll().ToList());
            if (IsTaxCategoriesLoadStale(operationVersion))
            {
                return;
            }
    ...
    private void LoadTaxPickerItems()
        => _ = LoadTaxPickerItemsAsync();

    private async Task LoadTaxPickerItemsAsync()
    {
        var operationVersion = Interlocked.Increment(ref _taxPickerLoadVersion);
        try
        {
            var allRules = await Task.Run(() => TaxRulesModule.GetAll().ToList());
            var allGroups = await Task.Run(() => TaxGroupsModule.GetAllWithRules().ToList());
            var allProfiles = allGroups.Where(g => !g.IsAutoManaged).ToList();

            if (IsTaxPickerLoadStale(operationVersion))
            {
                return;
            }
            ...
            await RunOnUiThreadAsync(() =>
            {
                ...
                _taxGroupsById = allGroups.ToDictionary(group => group.Id);
                ...
                if (noTax != null)
                {
                    TaxPickerItems.Add(BuildProfileItem(noTax));
                }
    ...
    private void SelectMatchingTaxPickerItem()
    {
        ...
        if (_taxGroupsById.TryGetValue(Draft.TaxGroupId, out var matchGroup) &&
            matchGroup is { IsAutoManaged: true } &&
            matchGroup.Rules.Count == 1)
        {
    ...
    private void RefreshButton_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            ReloadProducts(focusSearch: true);
        }
        catch (Exception ex)
        {
    ...
    private async void ImportDataButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            var hwnd = RetailStorePOS.UI.Common.Services.WindowInteropService.GetActiveWindow();
            ...
            // Read the header row plus a few sample rows so the dialog can
            // show the user the actual values behind each CSV column.
            // ImportColumnMappingDialog auto-detects a sensible mapping via
            // the existing alias tables; the user only adjusts outliers.
            CsvPreview csvPreview;
            ProductImportMapping suggestion;
            try
            {
                csvPreview = ProductImportService.PreviewSample(file.Path, sampleRows: 3);
                suggestion = ProductImportService.SuggestMapping(csvPreview.Headers);
            }
            catch (Exception ex)
            {
                LoginRuntime.ReportException(ex, "WinUiLogin.ProductsPage.ImportPreviewHeaders");
                SetStatus(
                    LocalizationHelper.Format("Products_Status_ImportFailedFormat", ex.Message),
                    InfoBarSeverity.Error);
                return;
            }

            if (csvPreview.Headers.Count == 0)
            {
                SetStatus(
                    LocalizationHelper.Format(
                        "Products_Status_ImportFailedFormat",
                        "The CSV file is empty or has no header row."),
                    InfoBarSeverity.Error);
                return;
            }

            var mappingDialog = new ImportColumnMappingDialog(csvPreview, suggestion)
            {
                XamlRoot = this.XamlRoot
            };
            var dialogResult = await mappingDialog.ShowAsync();
            if (dialogResult != ContentDialogResult.Primary || mappingDialog.ConfirmedMapping is null)
            {
                SetStatus(
                    LocalizationHelper.GetString("Products_Status_ImportCanceled"),
                    InfoBarSeverity.Informational);
                return;
            }
            var importMapping = mappingDialog.ConfirmedMapping;
    ...
    private async void ExportDataButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            picker.SuggestedStartLocation = PickerLocationId.DocumentsLibrary;
            // AOT Workaround: Native AOT strips the CCW for List<string> to IVector<string>.
            // By instantiating a FileOpenPicker, we can borrow its FileTypeFilter which is a native WinRT IVector<string>,
            // allowing us to pass it into FileTypeChoices without requiring C# COM marshalling.
            var winrtVector = new FileOpenPicker().FileTypeFilter;
            winrtVector.Add(".csv");
            picker.FileTypeChoices.Add("CSV Document", winrtVector);
    ...
    private async Task SaveSelectedProduct()
    {
        ...
        IsEditingSelectedProduct = false;
        await ReloadProductsAsync(product.Id, focusSearch: true);
    ...
    private async Task SaveNewProduct()
    {
        ...
        IsAddingProduct = false;
        Draft.Reset();
        await ReloadProductsAsync(product.Id);
    ...
    private void RaiseSelectedProductProperties()
    {
        ...
        OnPropertyChanged(nameof(ProductItemTemplate));
    ...
    private bool IsTaxCategoriesLoadStale(int operationVersion)
        => _isPageUnloaded || operationVersion != Volatile.Read(ref _taxCategoriesLoadVersion);

    private bool IsTaxPickerLoadStale(int operationVersion)
        => _isPageUnloaded || operationVersion != Volatile.Read(ref _taxPickerLoadVersion);

    private bool IsProductReloadStale(int operationVersion)
        => _isPageUnloaded || operationVersion != Volatile.Read(ref _productReloadVersion);
    ...
    private void QueueActivationRefresh(bool focusSearch)
    {
        // Defer all sync DB work to the next dispatcher cycle so the page
        // renders its skeleton/empty state first, then loads data. Splits
        // navigation feel from data-load feel.
        DispatcherQueue.TryEnqueue(() =>
        {
            LoadTaxCategories();
            LoadTaxPickerItems();
            ReloadProducts(focusSearch: focusSearch);
        });
    }
    ...
    private void AttachPageSubscriptions()
    {
        ...
        TaxPickerItems.CollectionChanged += TaxPickerItems_CollectionChanged;
        
        SyncCollectionToItemsControl(Products, ProductsListView.Items, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset));
        SyncCollectionToItemsControl(TaxPickerItems, EditTaxPicker.Items, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset));
        SyncCollectionToItemsControl(TaxPickerItems, AddTaxPicker.Items, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset));
    ...
    private void Products_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        {
            SyncCollectionToItemsControl(Products, ProductsListView.Items, e);
        });
    }

    private void TaxPickerItems_CollectionChanged(object? sender, NotifyCollectionChangedEventArgs e)
    {
        _uiDispatcher.TryEnqueue(() => 
        {
            SyncCollectionToItemsControl(TaxPickerItems, EditTaxPicker.Items, e);
            SyncCollectionToItemsControl(TaxPickerItems, AddTaxPicker.Items, e);
        });
    }

    private void SyncCollectionToItemsControl(System.Collections.IList source, ItemCollection target, NotifyCollectionChangedEventArgs e)
    {
        switch (e.Action)
        {
...
public sealed partial class ProductEditDraft : INotifyPropertyChanged
{
    ...
    public string? PendingSourceImagePath
    {
        ...
        set
        {
            if (SetProperty(ref _pendingSourceImagePath, value))
            {
                ...
                OnPropertyChanged(nameof(HasNoImageVisibility));
            }
        }
    }
    ...
    public Visibility HasNoImageVisibility => HasNoImage ? Visibility.Visible : Visibility.Collapsed;

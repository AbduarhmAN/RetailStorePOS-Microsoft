...
/// </summary>
public sealed partial class CsvColumnOption
{
...
/// </summary>
public sealed partial class ColumnMappingRow : INotifyPropertyChanged
{
    ...
    public string FieldDisplayName { get; set; } = "TEST STRING";
    ...
    /// <summary>The available choices for this row's combobox.</summary>

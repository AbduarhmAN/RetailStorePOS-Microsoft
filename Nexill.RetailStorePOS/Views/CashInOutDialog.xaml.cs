...
public sealed partial class CashInOutDialog : ContentDialog
{
    ...
    public string CashInOutDialog_Title => Loc["CashInOutDialog_Title.Text"];
    public string CashInOutDialog_Description => Loc["CashInOutDialog_Description.Text"];
    public string CashInOutDialog_ErrorBar => Loc["CashInOutDialog_ErrorBar.Title"];
    public string CashInOutDialog_AdjustmentTypeHeader => Loc["CashInOutDialog_AdjustmentTypeHeader.Text"];
    public string CashInOutDialog_CashInButton => Loc["CashInOutDialog_CashInButton.Content"];
    public string CashInOutDialog_CashOutButton => Loc["CashInOutDialog_CashOutButton.Content"];
    public string CashInOutDialog_AmountHeader => Loc["CashInOutDialog_AmountHeader.Text"];
    public string CashInOutDialog_AmountBox => Loc["CashInOutDialog_AmountBox.PlaceholderText"];
    public string CashInOutDialog_ReasonHeader => Loc["CashInOutDialog_ReasonHeader.Text"];
    public string CashInOutDialog_ReasonBox => Loc["CashInOutDialog_ReasonBox.PlaceholderText"];
    public string CashInOutDialog_PrimaryButtonText => Loc["CashInOutDialog.PrimaryButtonText"];
    public string CashInOutDialog_SecondaryButtonText => Loc["CashInOutDialog.SecondaryButtonText"];

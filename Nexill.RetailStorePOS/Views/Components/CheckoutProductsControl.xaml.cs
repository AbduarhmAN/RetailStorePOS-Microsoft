...
namespace RetailStorePOS.WinUiLogin.Views.Components
{
    public sealed partial class CheckoutProductsControl : UserControl
    {
        ...
        {
            if (e.ClickedItem is RetailStorePOS.WinUiLogin.Models.SearchResultItem item)
            {
        ...
        {
            if (sender is FrameworkElement fe && fe.DataContext is RetailStorePOS.WinUiLogin.Models.SearchResultItem item)
            {

...
///         are sorted with <see cref="StringComparison.Ordinal"/> (matches
///         <c>localeCompare</c> for the ASCII-only payload keys we use).</item>
/// </list>
///
/// All certificate field keys are ASCII, so ordinal sort and JS <c>localeCompare</c>
/// produce identical orderings. If the payload schema ever uses non-ASCII keys this
/// helper will need to be revisited together with the Edge Function.
/// </summary>

...
public sealed class SettingsViewModel : ObservableObject, IDisposable
{
    ...
    {
        _uiDispatcher = DispatcherQueue.GetForCurrentThread() ?? MainWindow.Current?.DispatcherQueue
    ...
    public System.Collections.Generic.IReadOnlyList<System.Collections.Generic.KeyValuePair<string, string>> RoundingStrategies => new System.Collections.Generic.List<System.Collections.Generic.KeyValuePair<string, string>>
    {
    ...
    private async Task SaveSessionSecurityPreferencesAsync(int sessionIdleTimeoutMinutes)
    {
        try
        {
            ...
            await RunOnUiThreadAsync(() =>
            {
                MainWindow.Current?.RefreshSessionIdleTimeoutSetting();
                StatusMessage = LocalizationHelper.GetString("Settings_Status_PrefsSaved");
            });
        }
        catch (Exception ex)
